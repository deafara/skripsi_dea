...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Tables -->
        <li class="nav-item">
            <a class="nav-link" href="{{ route('penyakits.index') }}">
...
<!-- Bootstrap Bundle with Popper (ensure the latest version) -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"
    integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous">
</script>

<script>
    function confirmDelete(PenyakitId) {
        $('#deleteConfirmationModal').modal('show');
        $('#deleteConfirmationModal').on('shown.bs.modal', function() {
            $('#deleteConfirmationModal button.btn-danger').attr('onclick', 'deletePenyakit(' + PenyakitId + ')');
        });
    }

    function deletePenyakit(PenyakitId) {
        $('#deleteForm' + PenyakitId).submit();
    }
</script>
</body>
